...
class Actor(nn.Module):
    ...
    def forward(self, state):
        ...
        action = torch.tanh(self.fc3(action)) # Tanh activation function used for continuous action values
        return action 
...
class Critic(nn.Module):
    ...
    def forward(self, state, action):
        ...
        x = F.relu(self.fc2(x))
        return self.fc3(x) # No activation as we want Q values directly
